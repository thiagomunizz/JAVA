...
this.getClass().getResource("Imagens/jav.jpg"), "jav.jpg"));
if (img != null){
...
ImageIcon(this.getClass().getResource("Imagens/agenda.png"), "agenda.png"));

menuAbreAgenda.setIcon(new
ImageIcon(this.getClass().getResource("Imagens/abreagenda.png"), "abreagenda.png"));
...
ImageIcon(this.getClass().getResource("Imagens/xx.png"), "xx.png"));
